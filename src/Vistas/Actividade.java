 ...
 */
public class Actividade extends javax.swing.JDialog {

//    TablaColor tablacolor = new TablaColor();
    /**
     * Creates new form Acciones
     */
    public Actividade(java.awt.Frame parent, boolean modal) {
        super(parent, modal);
        initComponents();
//        tablaactividades.setDefaultRenderer(tablaactividades.getColumnClass(0), tablacolor);
    ...
    public static void main(String args[]) {
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                Actividade dialog = new Actividade(new javax.swing.JFrame(), true);
